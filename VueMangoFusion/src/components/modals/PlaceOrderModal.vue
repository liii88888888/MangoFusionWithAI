  ...
  >
    ...
    >
      ...
      <form @submit.prevent="submitOrder">
        <div class="mb-3">
          <label for="pickupName" class="form-label">姓名</label>
          <input v-model="orderData.pickUpName" type="text" class="form-control" id="pickupName" />
        </div>

        <div class="mb-3">
          <label for="pickupPhoneNumber" class="form-label">电话号码</label>
          <input
        ...
        <div class="mb-4">
          <label for="pickupEmail" class="form-label">邮箱</label>
          <input

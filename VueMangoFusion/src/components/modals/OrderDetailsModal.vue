<template>
  <div
    v-if="order"
    class="position-fixed top-0 start-0 w-100 h-100 d-flex justify-content-center align-items-start bg-black bg-opacity-50"
    style="z-index: 1050; padding-top: 5vh"
  >
    <div
        ...
        <div class="sticky-top bg-body p-3 p-sm-4 border-bottom">
          ...
          >
            <div class="d-flex align-items-center">
              ...
              <h5 class="mb-0 fs-5 text-success">订单 #{{ order.orderHeaderId }}</h5>
            </div>
            <button
              @click="closeModal"
              ...
              <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-3">
                  <div class="d-flex align-items-center mb-3">
                    ...
                    <h6 class="card-title mb-0">客户信息</h6>
                  </div>
              ...
              <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-3">
                  <div class="d-flex align-items-center mb-3">
                    ...
                    <h6 class="card-title mb-0">订单摘要</h6>
                  </div>
                  <div class="d-flex flex-column gap-2">
                    <div class="d-flex justify-content-between align-items-center">
                      <span class="text-body-secondary small">菜品总数</span>
                      <span class="fw-bold">{{ order.totalItem }}</span>
                    </div>
                    <div class="d-flex justify-content-between align-items-center">
                      <span class="text-body-secondary small">总金额</span>
          ...
          <div class="card border-0 shadow-sm mb-4">
            <div class="card-body p-3">
              <div class="d-flex align-items-center mb-3">
                ...
                <h6 class="card-title mb-0">订单菜品</h6>
              </div>
          ...
          <div class="card border-0 shadow-sm">
            <div class="card-body p-3">
              <div class="d-flex align-items-center mb-3">
                ...
                <h6 class="card-title mb-0">订单状态</h6>
              </div>

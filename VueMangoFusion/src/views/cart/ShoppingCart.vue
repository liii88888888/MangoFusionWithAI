            ...
            <div class="card-body p-0">
              <div class="table-responsive">
                <table class="table table-hover mb-0">
                  <thead>
                    <tr>
                      <th scope="col" class="ps-4 fw-light" style="width: 30%">菜品</th>
                      <th scope="col" class="text-center fw-light" style="width: 15%">价格</th>
          ...
          <div class="row g-4">
            ...
            <div class="col-md-6">
              <div class="card border-0 shadow-sm">
                <div class="card-body">
                  <h4 class="card-title h6 mb-3">订单摘要</h4>
                  <div class="d-flex justify-content-between mb-2">
                    <span class="text-body-secondary">菜品数：</span>
                  ...
                  <div class="text-center mt-1">
                    <span class="text-danger">订单将在30分钟内准备好，请及时取餐。</span>
                  </div>
                </div>
              </div>
            </div>
